...
typedef struct _VCI_LIN_RSPONSE_CFG
{
    BYTE ID;
    BYTE DataLen;
    BYTE Data[8];
} ZCAN_LIN_RSPONSE_CFG, *PZCAN_LIN_RSPONSE_CFG;
...
{
    UINT reqID;             // ��������ID����Χ0~65535�����������Ψһ��ʶ
    BYTE channelIdx;        // �豸ͨ������ 0~255
    BYTE reserved0[3];      // ����
    UINT src_addr;          // �����ַ
    UINT dst_addr;          // ��Ӧ��ַ
