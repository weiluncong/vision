...
DEFINE_double(v_capilot_version, 3.2, "capilot version");
...
DEFINE_string(v_data_address_soc1, "tcp://192.168.1.175:7890", "define init soc1 zmq address");
DEFINE_string(v_proto_address_soc1, "tcp://192.168.1.175:7766", "define init soc1 zmq proto address");
